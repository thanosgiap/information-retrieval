...
class HomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        elseif ($searchIn === 'party'){
            $party_members = Member::where('political_party', $searchQuery)->paginate(5);
        }
        ...
        return view('results', compact('speeches', 'members', 'party_members', 'searchIn'))->with('query', $searchQuery);
    }
}
